...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->role == 'local_admin' || $user->role == 'master_admin') {
            ...
            $closedComplaints = \App\Models\Complaint::with(['user', 'issue', 'department'])->where('dept_user_id', '=', $user->$user->id)->where('complaint_status', '=', 'Closed')->orWhere('complaint_status', '=', 'Resolved')->where('dept_id', '=', $user->dept_id)->count('id');
